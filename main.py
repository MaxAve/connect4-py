...
import torch
import random
from models_v1 import neural_network
...
#     '''
#     breedable_population_size = 6 # Amount of models that will be allowed to breed after each round
#     offspring_population_size = int(breedable_population_size * (breedable_population_size - 1))

#     # Create initial population
#     active_models = []
#     model = neural_network.NN()
#     model.load_state_dict(torch.load("models/nn-5"))
#     model.eval()
...
#     # Save the model
#     torch.save(winner_model.state_dict(), "/home/maxave/Desktop/connect4-py/models/nn-6")
#     return
#     #'''

#     loaded_model = neural_network.NN()
#     loaded_model.load_state_dict(torch.load("models_v1/nn-1"))
#     loaded_model.eval()
...
#         # Computer move
#         print("Computer is thinking...")
#         cpu_move = computer_move.minimax(board, 6, False, float("-inf"), float("inf"))
